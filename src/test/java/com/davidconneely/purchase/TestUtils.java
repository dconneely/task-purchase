...
public final class TestUtils {
  ...
  public static final BigDecimal CONVERTED_AMOUNT_GOOD =
      BigDecimal.valueOf(
          7851, 2); // 78.51 == PURCHASE_AMOUNT_GOOD.multiply(EXCHANGE_RATE_GOOD).setScale(2,
  ...
  public static PurchaseResponse newGoodResponse() {
    return new PurchaseResponse(
        ID_GOOD,
        DESCRIPTION_GOOD,
        TRANSACTION_DATE_GOOD,
        PURCHASE_AMOUNT_GOOD,
        EXCHANGE_RATE_GOOD,
        CONVERTED_AMOUNT_GOOD);
  }
