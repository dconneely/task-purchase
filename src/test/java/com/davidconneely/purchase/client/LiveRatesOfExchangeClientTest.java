...
@RestClientTest(
    components = {ApplicationConfig.class, ClientProperties.class},
    properties = {"app.purchase.treasury-fiscalData.cache-enabled=false"})
public class LiveRatesOfExchangeClientTest {
  @Autowired private RatesOfExchangeClient client;
  ...
  public void testGetSingleRateSuccess() {
    ...
    BigDecimal exchangeRate =
        client.getSingleRate(COUNTRY_CURRENCY_DESC_UK2015, TRANSACTION_DATE_GOOD);
