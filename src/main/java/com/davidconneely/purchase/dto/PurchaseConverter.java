...
public class PurchaseConverter {
    ...
    /**
     * Converts a stored purchase transaction and an exchange rate into the required retrieved response.
     *
    ...
    public PurchaseResponse responseFromEntity(PurchaseEntity entity, BigDecimal exchangeRate) {
        ...
        return new PurchaseResponse(entity.getId(), entity.getDescription(), entity.getTransactionDate(), purchaseAmount, exchangeRate, convertedAmount);
    }
     ...
     * @param exchangeRate   number of foreign currency units in a US dollar.
     * @return the amount in foreign currency units, with appropriate rounding (to two decimal places / cents).
     */
