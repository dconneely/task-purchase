...
public class RestExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
  private static final URI URI_ILLEGAL_ARGUMENT =
      URI.create("https://purchase.davidconneely.com/illegal-argument");
  ...
  // If our custom exceptions (which extend ResponseStatusException) are thrown, then we end up in
  // base class.
}
